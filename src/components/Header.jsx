    ...
    <div className='min-h-screen mb-4 bg-cover bg-center flex items-center w-full overflow-hidden' id='Header' style={
        ...
        <div className='container text-center mx-auto py-4 px-6 md:px-20 lg:px-32 text-white'>
            ...
            <div className='space-x-6 mt-16'>
                <a href='#Projects' className='border border-purple-600 bg-purple-600 px-8 py-3 rounded-md'>Projects</a>
                <a href='#Contact' className='border border-white px-8 py-3 rounded-md'>Contact Us</a>
            </div>
        </div>
    </div>
  )
